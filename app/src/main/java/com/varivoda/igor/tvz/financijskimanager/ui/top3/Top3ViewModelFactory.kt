...
class Top3ViewModelFactory(private val productRepository: BaseProductRepository, private val storeRepository: BaseStoreRepository) : ViewModelProvider.Factory{
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if(modelClass.isAssignableFrom(Top3ViewModel::class.java)){
            return Top3ViewModel(productRepository, storeRepository) as T
        }
