...
@Database(entities = [Product::class,Location::class,County::class, Store::class, Bill::class,
                        Customer::class,Employee::class,ProductsOnBill::class],version = 2,exportSchema = false)
                    ...
                    instance = Room.databaseBuilder(context.applicationContext,AppDatabase::class.java,"appDatabase.db")
                        .addCallback(object: RoomDatabase.Callback() {
                            override fun onCreate(db: SupportSQLiteDatabase) {
                                ...
                                db.execSQL("INSERT INTO Product VALUES(1,'SSD 120GB WD Green',246,1)")
                                db.execSQL("INSERT INTO Product VALUES(2,'SSD 256GB Gigabyte',349,1)")
                                db.execSQL("INSERT INTO Product VALUES(3,'SSD 240GB Kingston',381,1)")
                                db.execSQL("INSERT INTO Product VALUES(4,'Napajanje NaviaTech 400W',170,1)")
                                db.execSQL("INSERT INTO Product VALUES(5,'Napajanje Xilence 500W',251,1)")
                                db.execSQL("INSERT INTO Product VALUES(6,'Napajanje AKYGA 700W',299,1)")
                                db.execSQL("INSERT INTO Product VALUES(7,'Patriot Signature DDR4 2666Mhz 4GB',199,1)")
                                db.execSQL("INSERT INTO Product VALUES(8,'Kingston DDR4 2400MHz 8GB',369,1)")
                                db.execSQL("INSERT INTO Product VALUES(9,'Memorija G.Skill Aegis 8GB DDR4 3200MHz',349,1)")
                                db.execSQL("INSERT INTO Product VALUES(10,'Kingmax Zeus Gaming 16GB DDR4 3000MHz',466,1)")
                                db.execSQL("INSERT INTO Product VALUES(11,'Crucial 16GB DDR4 3200 MT/s',724,1)")
                                db.execSQL("INSERT INTO Product VALUES(12,'Procesor AMD Ryzen 3 1200',349,1)")
                                db.execSQL("INSERT INTO Product VALUES(13,'Procesor Intel Core i3 9100F',722,1)")
                                db.execSQL("INSERT INTO Product VALUES(14,'Procesor AMD Ryzen 5 1600 AF',799,1)")
                                db.execSQL("INSERT INTO Product VALUES(15,'Procesor Intel core i5 9400F',1249,1)")
                                db.execSQL("INSERT INTO Product VALUES(16,'Procesor AMD Ryzen Threadripper',1303,1)")
                                db.execSQL("INSERT INTO Product VALUES(17,'Procesor Intel core i5 9600K',2029,1)")
                                db.execSQL("INSERT INTO Product VALUES(18,'HP LA2205wg 22\" monitor',498,2)")
                                db.execSQL("INSERT INTO Product VALUES(19,'Philips 22\" 223V5LSB2/10 monitor',650,2)")
                                db.execSQL("INSERT INTO Product VALUES(20,'Monitor Asus VP247HAE',720,2)")
                                db.execSQL("INSERT INTO Product VALUES(21,'Acer Monitor V226HQLBbi 21.5',844,2)")
                                db.execSQL("INSERT INTO Product VALUES(22,'Monitor LG 22MK400H 24.0',778,2)")
