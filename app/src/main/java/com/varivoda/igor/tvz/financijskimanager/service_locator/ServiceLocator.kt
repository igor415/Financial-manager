        ...
        val new = Room.databaseBuilder(context.applicationContext,AppDatabase::class.java,"appDatabase1.db")
           /* .addCallback(object: RoomDatabase.Callback() {
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    db.execSQL("INSERT INTO PaymentMethod VALUES(1, 'Gotovina')")
                    db.execSQL("INSERT INTO PaymentMethod VALUES(2, 'Kartice')")
                    db.execSQL("INSERT INTO PaymentMethod VALUES(3, 'Paypal')")
                    db.execSQL("INSERT INTO BILL VALUES(1,1,1,5,1,'2020-06-01','11:55')")
                    db.execSQL("INSERT INTO BILL VALUES(2,4,2,4,1,'2020-06-01','12:55')")
                    db.execSQL("INSERT INTO BILL VALUES(3,7,3,3,2,'2020-06-01','12:55')")
                    db.execSQL("INSERT INTO BILL VALUES(4,10,4,2,2,'2020-06-01','13:55')")
                    db.execSQL("INSERT INTO BILL VALUES(5,16,5,8,2,'2020-06-01','14:55')")
                    db.execSQL("INSERT INTO BILL VALUES(6,13,6,7,2,'2020-06-01','13:55')")
                    db.execSQL("INSERT INTO BILL VALUES(7,13,6,7,2,'2020-06-01','14:55')")
                    db.execSQL("INSERT INTO BILL VALUES(8,13,6,7,3,'2020-06-01','14:55')")
                    db.execSQL("INSERT INTO BILL VALUES(9,13,6,7,1,'2020-06-30','15:55')")
                    db.execSQL("INSERT INTO BILL VALUES(10,13,6,7,1,'2020-09-07','11:55')")
                    db.execSQL("INSERT INTO BILL VALUES(11,13,5,6,1,'2020-09-08','15:55')")
                    db.execSQL("INSERT INTO BILL VALUES(12,13,5,5,1,'2020-09-09','13:55')")
                    db.execSQL("INSERT INTO BILL VALUES(13,11,5,4,1,'2020-09-15','11:55')")
                    db.execSQL("INSERT INTO BILL VALUES(14,12,1,3,1,'2020-09-13','12:55')")
                    db.execSQL("INSERT INTO BILL VALUES(15,14,2,2,1,'2020-09-12','15:55')")
                    db.execSQL("INSERT INTO BILL VALUES(16,14,1,3,1,'2020-07-27','12:55')")
                    db.execSQL("INSERT INTO BILL VALUES(17,15,2,4,1,'2020-07-25','15:55')")
                    db.execSQL("INSERT INTO BILL VALUES(18,16,1,5,1,'2020-07-22','10:55')")
                    db.execSQL("INSERT INTO BILL VALUES(19,11,2,6,2,'2020-07-21','08:55')")
                    db.execSQL("INSERT INTO BILL VALUES(20,12,1,8,2,'2020-07-11','10:55')")
                    db.execSQL("INSERT INTO BILL VALUES(21,14,5,10,2,'2020-11-28','12:55')")
                    db.execSQL("INSERT INTO BILL VALUES(22,13,4,11,2,'2020-11-29','08:05')")
                    db.execSQL("INSERT INTO BILL VALUES(23,1,1,5,2,'2020-12-01','11:55')")
                    ...
                    db.execSQL("INSERT INTO ProductsOnBill VALUES(24,1,4,1)")
