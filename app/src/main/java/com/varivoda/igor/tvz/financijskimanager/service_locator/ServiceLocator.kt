        ...
        val new = Room.databaseBuilder(context.applicationContext,AppDatabase::class.java,"appDatabase.db")
            .addCallback(object: RoomDatabase.Callback() {
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    db.execSQL("INSERT INTO BILL VALUES(10,13,6,7,'2020-09-07')")
                    db.execSQL("INSERT INTO BILL VALUES(11,13,5,6,'2020-09-08')")
                    db.execSQL("INSERT INTO BILL VALUES(12,13,5,5,'2020-09-09')")
                    db.execSQL("INSERT INTO BILL VALUES(13,11,5,4,'2020-09-15')")
                    db.execSQL("INSERT INTO BILL VALUES(14,12,1,3,'2020-09-13')")
                    db.execSQL("INSERT INTO BILL VALUES(15,14,2,2,'2020-09-12')")
                    db.execSQL("INSERT INTO BILL VALUES(16,14,1,3,'2020-07-27')")
                    db.execSQL("INSERT INTO BILL VALUES(17,15,2,4,'2020-07-25')")
                    db.execSQL("INSERT INTO BILL VALUES(18,16,1,5,'2020-07-22')")
                    db.execSQL("INSERT INTO BILL VALUES(19,11,2,6,'2020-07-21')")
                    db.execSQL("INSERT INTO BILL VALUES(20,12,1,8,'2020-07-11')")
                    db.execSQL("INSERT INTO BILL VALUES(21,14,5,10,'2020-11-28')")
                    db.execSQL("INSERT INTO BILL VALUES(22,13,4,11,'2020-11-29')")
